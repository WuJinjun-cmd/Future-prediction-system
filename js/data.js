...
const MAJOR_CATEGORIES = {
  ...
  '数据科学': { category: '计算机/AI', score: 92, demand: '极高', outlook: '大数据时代，数据驱动决策成为主流' },
  '数据科学与大数据技术': { category: '计算机/AI', score: 90, demand: '极高', outlook: '985投档线持续走高，就业薪资领先' },
  '智能科学与技术': { category: '计算机/AI', score: 89, demand: '很高', outlook: '智能系统未来将渗入各行各业' },
  '物联网工程': { category: '计算机/AI', score: 83, demand: '很高', outlook: '万物互联时代的基础技术' },
  '网络空间安全': { category: '计算机/AI', score: 88, demand: '很高', outlook: '数字化时代的刚需，人才缺口巨大' },
  '信息安全': { category: '计算机/AI', score: 87, demand: '很高', outlook: '企业安全合规需求持续增长' },
  '区块链工程': { category: '计算机/AI', score: 84, demand: '高', outlook: 'Web3和数字经济的核心基础设施' },

  // 电子信息类
  '电子信息工程': { category: '电子信息', score: 84, demand: '很高', outlook: '通信、芯片、消费电子行业需求稳定' },
  '通信工程': { category: '电子信息', score: 82, demand: '很高', outlook: '5G/6G建设持续推进，通信人才需求大' },
  ...
  '集成电路设计与集成系统': { category: '电子信息', score: 92, demand: '极高', outlook: '国家战略重点，长期利好，投档线直逼计算机' },
  '光电信息科学与工程': { category: '电子信息', score: 80, demand: '高', outlook: '光通信和光学设备领域稳定增长' },
  '电气工程及其自动化': { category: '电子信息', score: 84, demand: '高', outlook: '电网、新能源、智能制造领域需求大' },
  '自动化': { category: '电子信息', score: 83, demand: '高', outlook: '工业4.0和智能制造的核心专业' },

  // 医学类
  '临床医学': { category: '医学', score: 92, demand: '极高', outlook: '医疗健康永远是人类刚需，985投档线极高' },
  '口腔医学': { category: '医学', score: 93, demand: '极高', outlook: '收入可观，就业灵活度高的黄金专业' },
  '基础医学': { category: '医学', score: 80, demand: '中高', outlook: '医学科研方向，适合学术路线，投档线低于临床' },
  ...
  // 金融经济类
  '金融学': { category: '金融经济', score: 85, demand: '高', outlook: '金融行业核心岗位竞争激烈但回报丰厚' },
  '金融工程': { category: '金融经济', score: 88, demand: '高', outlook: '量化金融方向，数理能力强者优势明显' },
  '经济学': { category: '金融经济', score: 82, demand: '中高', outlook: '适用面广但需结合其他技能提升竞争力' },
  '国际经济与贸易': { category: '金融经济', score: 70, demand: '中', outlook: '全球化波动影响需求，跨境电商是新方向' },
  '会计学': { category: '金融经济', score: 78, demand: '高', outlook: '稳定刚需，CPA持证者竞争力强' },
  '财务管理': { category: '金融经济', score: 76, demand: '高', outlook: '企业财务数字化转型带来新机遇' },

  // 法律/管理类
  '法学': { category: '法律管理', score: 82, demand: '中高', outlook: '法考通过后职业发展空间大' },
  '工商管理': { category: '法律管理', score: 72, demand: '中', outlook: '需结合行业深耕，单靠专业竞争力有限' },
  '人力资源管理': { category: '法律管理', score: 68, demand: '中高', outlook: '组织发展领域有增长空间' },
  '市场营销': { category: '法律管理', score: 65, demand: '中高', outlook: '数字营销方向有增量机会' },

  // 人文社科类
  '汉语言文学': { category: '人文社科', score: 72, demand: '中', outlook: '内容创作、编辑出版、教育方向' },
  ...
  '哲学': { category: '人文社科', score: 62, demand: '中低', outlook: '批判性思维是核心竞争力，需结合行业应用' },
  '历史学': { category: '人文社科', score: 60, demand: '中低', outlook: '文化教育、文博产业、内容创作' },

  // 理科基础类
  '数学与应用数学': { category: '基础理学', score: 85, demand: '中高', outlook: 'AI时代数学功底价值凸显，转行空间大' },
  '物理学': { category: '基础理学', score: 78, demand: '中', outlook: '量子计算、半导体等前沿领域有高端需求' },
  '化学': { category: '基础理学', score: 72, demand: '中', outlook: '新能源材料和化工方向有稳定需求' },
  '生物科学': { category: '基础理学', score: 72, demand: '中', outlook: '生物医药和基因技术是未来方向' },
  '统计学': { category: '基础理学', score: 88, demand: '很高', outlook: '数据科学时代的硬通货' },

  // 工科传统类
  '机械工程': { category: '传统工科', score: 74, demand: '中高', outlook: '智能制造升级带动新需求' },
  '土木工程': { category: '传统工科', score: 60, demand: '中', outlook: '基建增速放缓，但城市更新仍有空间' },
  '建筑学': { category: '传统工科', score: 76, demand: '中', outlook: '绿色建筑和智能设计是新方向' },
  '材料科学与工程': { category: '传统工科', score: 78, demand: '中高', outlook: '新能源材料、半导体材料前景好' },
  '能源与动力工程': { category: '传统工科', score: 80, demand: '中高', outlook: '新能源转型带来增量机会' },
  '环境工程': { category: '传统工科', score: 68, demand: '中', outlook: '双碳目标下环保投入加大' },

  // 艺术设计类
  '数字媒体技术': { category: '艺术设计', score: 80, demand: '高', outlook: '游戏、影视、元宇宙内容产业需求大' },
  '工业设计': { category: '艺术设计', score: 68, demand: '中', outlook: '智能硬件和消费电子领域有空间' },
  ...
  '信息与计算科学': { category: '计算机/AI', score: 86, demand: '高', outlook: '数学+计算机复合型人才稀缺' },
  ...
  '电子信息科学与技术': { category: '电子信息', score: 83, demand: '高', outlook: '电子+信息的复合型专业前景好' },
  ...
  '机器人工程': { category: '电子信息', score: 90, demand: '极高', outlook: '工业4.0和服务机器人爆发式增长' },

  // 机械/交通/航空航天
  '车辆工程': { category: '传统工科', score: 76, demand: '高', outlook: '新能源汽车和智能驾驶带来新机遇' },
  '船舶与海洋工程': { category: '传统工科', score: 64, demand: '中', outlook: '航运和海洋资源开发有稳定需求' },
  '航空航天工程': { category: '传统工科', score: 87, demand: '很高', outlook: '商业航天和低空经济是国家战略方向' },
  '飞行器设计与工程': { category: '传统工科', score: 86, demand: '很高', outlook: '大飞机和无人机产业蓬勃发展' },
  '飞行器动力工程': { category: '传统工科', score: 85, demand: '很高', outlook: '航空发动机核心技术突破期' },
  '交通运输': { category: '传统工科', score: 68, demand: '中', outlook: '智慧交通和物流升级带来新方向' },
  '交通工程': { category: '传统工科', score: 67, demand: '中', outlook: '轨道交通和城市交通管理' },
  '轮机工程': { category: '传统工科', score: 62, demand: '中', outlook: '船舶动力和海洋工程方向' },
  '过程装备与控制工程': { category: '传统工科', score: 66, demand: '中', outlook: '化工装备和过程控制领域' },
  '智能制造工程': { category: '传统工科', score: 84, demand: '很高', outlook: '制造强国战略下的热门新专业' },
  ...
  '风景园林': { category: '传统工科', score: 64, demand: '中', outlook: '生态文明建设带动景观设计需求' },
  ...
  '新能源材料与器件': { category: '传统工科', score: 88, demand: '很高', outlook: '光伏/储能/氢能材料是万亿级赛道' },
  '纳米材料与技术': { category: '传统工科', score: 82, demand: '高', outlook: '前沿新材料方向，研发岗位多' },
  '化学工程与工艺': { category: '传统工科', score: 72, demand: '中高', outlook: '传统化工向绿色化工转型中' },
  ...
  '生物医学工程': { category: '基础理学', score: 84, demand: '很高', outlook: '医疗器械和AI辅助诊断前景广阔' },
  '生物制药': { category: '基础理学', score: 86, demand: '很高', outlook: '精准医疗和细胞治疗蓬勃发展' },
  '农业工程': { category: '传统工科', score: 89, demand: '中低', outlook: '智慧农业和精准农业是新增长点' },
  '农学': { category: '基础理学', score: 62, demand: '中', outlook: '种业振兴和粮食安全国家战略' },
  '植物保护': { category: '基础理学', score: 60, demand: '中低', outlook: '绿色植保和生物农药有发展' },
  '动物科学': { category: '基础理学', score: 60, demand: '中', outlook: '畜牧业和宠物经济有空间' },
  ...
  // 能源/矿业/安全
  '核工程与核技术': { category: '传统工科', score: 82, demand: '很高', outlook: '核能和核技术应用战略地位提升' },
  ...
  '应用物理学': { category: '基础理学', score: 76, demand: '中', outlook: '半导体/量子/光学等方向有高端需求' },
  '应用化学': { category: '基础理学', score: 70, demand: '中', outlook: '新材料和化工方向应用广泛' },
  '天文学': { category: '基础理学', score: 70, demand: '中低', outlook: '天体物理和航天探索高端科研方向' },
  '大气科学': { category: '基础理学', score: 70, demand: '中', outlook: '气象和气候变化的科研和公共服务' },
  '海洋科学': { category: '基础理学', score: 68, demand: '中', outlook: '海洋资源和环境保护的战略方向' },
  ...
  // 医学补充
  '预防医学': { category: '医学', score: 78, demand: '高', outlook: '公共卫生体系建设持续加强' },
  ...
  '智能医学工程': { category: '医学', score: 86, demand: '极高', outlook: 'AI+医疗交叉的黄金新赛道' },
  ...
  '税收学': { category: '金融经济', score: 74, demand: '中高', outlook: '税务筹划和企业合规需求旺盛' },
  '信用管理': { category: '金融经济', score: 72, demand: '中高', outlook: '征信和信用评级行业增长' },
  '数字经济': { category: '金融经济', score: 84, demand: '很高', outlook: '数字经济和平台经济是国家战略' },
  '供应链管理': { category: '法律管理', score: 76, demand: '高', outlook: '全球供应链重构带来新需求' },
  '物流管理': { category: '法律管理', score: 66, demand: '中高', outlook: '电商物流和智慧供应链方向' },
  '电子商务': { category: '法律管理', score: 70, demand: '中高', outlook: '直播电商和跨境电商蓬勃发展' },
  ...
  '临床医学类': { category: '医学', score: 96, demand: '极高', outlook: '985投档均分700 — 医学精英之路' },
  '口腔医学类': { category: '医学', score: 88, demand: '极高', outlook: '985投档均分669 — 口腔医学持续热门' },
  '基础医学类': { category: '医学', score: 83, demand: '高', outlook: '985投档均分652 — 医学研究基础' },
  '预防医学类': { category: '医学', score: 86, demand: '高', outlook: '985投档均分664 — 公共卫生人才紧缺' },
  '药学类': { category: '医学', score: 83, demand: '高', outlook: '985投档均分652 — 药学研发前景好' },
  ...
  '电子信息类': { category: '电子信息', score: 85, demand: '高', outlook: '985投档均分658 — 电子信息大类招生' },
  ...
  '计算机类': { category: '计算机/AI', score: 89, demand: '极高', outlook: '985投档均分674 — 计算机大类精英' },
  ...
  '金融学类': { category: '金融经济', score: 85, demand: '高', outlook: '985投档均分661 — 金融核心赛道' },
  ...
  '法学类': { category: '法律管理', score: 85, demand: '中高', outlook: '985投档均分661 — 法考后职业空间大' },
  '工商管理类': { category: '法律管理', score: 72, demand: '中', outlook: '985投档均分611 — 需结合行业深耕' },
  '公共管理类': { category: '法律管理', score: 68, demand: '中', outlook: '985投档均分598 — 公务员方向稳定' },
  ...
  '社会学类': { category: '人文社科', score: 83, demand: '中', outlook: '985投档均分653 — 用户研究方向' },
  '英语': { category: '人文社科', score: 63, demand: '中低', outlook: '985投档均分577 — 受AI翻译冲击' },
  '日语': { category: '人文社科', score: 59, demand: '中低', outlook: '985投档均分563 — 日企方向稳定' },
  ...
  '考古学': { category: '人文社科', score: 82, demand: '中低', outlook: '985投档均分649 — 文化遗产保护' },
