...
const MAJOR_CATEGORIES = {
  // 热门高薪专业
  '计算机科学与技术': { category: '计算机/AI', score: 74, demand: '极高', outlook: '人工智能、互联网、金融科技等领域需求旺盛' },
  '软件工程': { category: '计算机/AI', score: 78, demand: '极高', outlook: '全行业数字化转型的核心驱动力' },
  ...
  '数据科学与大数据技术': { category: '计算机/AI', score: 77, demand: '极高', outlook: '985投档线持续走高，就业薪资领先' },
  ...
  '通信工程': { category: '电子信息', score: 68, demand: '很高', outlook: '5G/6G建设持续推进，通信人才需求大' },
  '电子科学与技术': { category: '电子信息', score: 75, demand: '很高', outlook: '芯片产业的战略重要性日益提升' },
  '微电子科学与工程': { category: '电子信息', score: 86, demand: '很高', outlook: '国产芯片自主研发的核心专业，985投档线极高' },
  '集成电路设计与集成系统': { category: '电子信息', score: 80, demand: '极高', outlook: '国家战略重点，长期利好，投档线直逼计算机' },
  '光电信息科学与工程': { category: '电子信息', score: 66, demand: '高', outlook: '光通信和光学设备领域稳定增长' },
  '电气工程及其自动化': { category: '电子信息', score: 75, demand: '高', outlook: '电网、新能源、智能制造领域需求大' },
  '自动化': { category: '电子信息', score: 69, demand: '高', outlook: '工业4.0和智能制造的核心专业' },

  // 医学类
  '临床医学': { category: '医学', score: 88, demand: '极高', outlook: '医疗健康永远是人类刚需，985投档线极高' },
  '口腔医学': { category: '医学', score: 88, demand: '极高', outlook: '收入可观，就业灵活度高的黄金专业' },
  '基础医学': { category: '医学', score: 90, demand: '中高', outlook: '医学科研方向，适合学术路线，投档线低于临床' },
  ...
  // 金融经济类
  '金融学': { category: '金融经济', score: 63, demand: '高', outlook: '金融行业核心岗位竞争激烈但回报丰厚' },
  '金融工程': { category: '金融经济', score: 71, demand: '高', outlook: '量化金融方向，数理能力强者优势明显' },
  '经济学': { category: '金融经济', score: 79, demand: '中高', outlook: '适用面广但需结合其他技能提升竞争力' },
  '国际经济与贸易': { category: '金融经济', score: 58, demand: '中', outlook: '全球化波动影响需求，跨境电商是新方向' },
  '会计学': { category: '金融经济', score: 69, demand: '高', outlook: '稳定刚需，CPA持证者竞争力强' },
  ...
  // 理科基础类
  '数学与应用数学': { category: '基础理学', score: 83, demand: '中高', outlook: 'AI时代数学功底价值凸显，转行空间大' },
  '物理学': { category: '基础理学', score: 83, demand: '中', outlook: '量子计算、半导体等前沿领域有高端需求' },
  '化学': { category: '基础理学', score: 83, demand: '中', outlook: '新能源材料和化工方向有稳定需求' },
  '生物科学': { category: '基础理学', score: 82, demand: '中', outlook: '生物医药和基因技术是未来方向' },
  '统计学': { category: '基础理学', score: 77, demand: '很高', outlook: '数据科学时代的硬通货' },

  // 工科传统类
  '机械工程': { category: '传统工科', score: 89, demand: '中高', outlook: '智能制造升级带动新需求' },
  '土木工程': { category: '传统工科', score: 51, demand: '中', outlook: '基建增速放缓，但城市更新仍有空间' },
  '建筑学': { category: '传统工科', score: 75, demand: '中', outlook: '绿色建筑和智能设计是新方向' },
  ...
  '计算机类': { category: '计算机/AI', score: 73, demand: '极高', outlook: '985投档均分674 — 计算机大类精英' },
  ...
  '法学类': { category: '法律管理', score: 84, demand: '中高', outlook: '985投档均分661 — 法考后职业空间大' },
