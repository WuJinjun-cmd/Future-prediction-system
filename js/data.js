...
const MAJOR_CATEGORIES = {
  // 热门高薪专业
  '计算机科学与技术': { category: '计算机/AI', score: 80, demand: '极高', outlook: '人工智能、互联网、金融科技等领域需求旺盛' },
  '软件工程': { category: '计算机/AI', score: 75, demand: '极高', outlook: '全行业数字化转型的核心驱动力' },
  '人工智能': { category: '计算机/AI', score: 79, demand: '极高', outlook: '未来十年最具发展潜力的方向之一' },
  '数据科学': { category: '计算机/AI', score: 74, demand: '极高', outlook: '大数据时代，数据驱动决策成为主流' },
  '数据科学与大数据技术': { category: '计算机/AI', score: 74, demand: '极高', outlook: '985投档线持续走高，就业薪资领先' },
  ...
  // 电子信息类
  '电子信息工程': { category: '电子信息', score: 83, demand: '很高', outlook: '通信、芯片、消费电子行业需求稳定' },
  '通信工程': { category: '电子信息', score: 73, demand: '很高', outlook: '5G/6G建设持续推进，通信人才需求大' },
  '电子科学与技术': { category: '电子信息', score: 70, demand: '很高', outlook: '芯片产业的战略重要性日益提升' },
  '微电子科学与工程': { category: '电子信息', score: 96, demand: '很高', outlook: '国产芯片自主研发的核心专业，985投档线极高' },
  '集成电路设计与集成系统': { category: '电子信息', score: 89, demand: '极高', outlook: '国家战略重点，长期利好，投档线直逼计算机' },
  ...
  // 医学类
  '临床医学': { category: '医学', score: 94, demand: '极高', outlook: '医疗健康永远是人类刚需，985投档线极高' },
  ...
  // 金融经济类
  '金融学': { category: '金融经济', score: 72, demand: '高', outlook: '金融行业核心岗位竞争激烈但回报丰厚' },
  '金融工程': { category: '金融经济', score: 71, demand: '高', outlook: '量化金融方向，数理能力强者优势明显' },
  '经济学': { category: '金融经济', score: 88, demand: '中高', outlook: '适用面广但需结合其他技能提升竞争力' },
  '国际经济与贸易': { category: '金融经济', score: 58, demand: '中', outlook: '全球化波动影响需求，跨境电商是新方向' },
  '会计学': { category: '金融经济', score: 66, demand: '高', outlook: '稳定刚需，CPA持证者竞争力强' },
  '财务管理': { category: '金融经济', score: 63, demand: '高', outlook: '企业财务数字化转型带来新机遇' },

  // 法律/管理类
  '法学': { category: '法律管理', score: 91, demand: '中高', outlook: '法考通过后职业发展空间大' },
  ...
  // 理科基础类
  '数学与应用数学': { category: '基础理学', score: 93, demand: '中高', outlook: 'AI时代数学功底价值凸显，转行空间大' },
  ...
  '统计学': { category: '基础理学', score: 87, demand: '很高', outlook: '数据科学时代的硬通货' },

  // 工科传统类
  '机械工程': { category: '传统工科', score: 93, demand: '中高', outlook: '智能制造升级带动新需求' },
  ...
  '临床医学类': { category: '医学', score: 94, demand: '极高', outlook: '985投档均分700 — 医学精英之路' },
  ...
  '计算机类': { category: '计算机/AI', score: 80, demand: '极高', outlook: '985投档均分674 — 计算机大类精英' },
  ...
  '金融学类': { category: '金融经济', score: 72, demand: '高', outlook: '985投档均分661 — 金融核心赛道' },
  '经济学类': { category: '金融经济', score: 88, demand: '高', outlook: '985投档均分661 — 经济学基础扎实' },
  ...
  '法学类': { category: '法律管理', score: 91, demand: '中高', outlook: '985投档均分661 — 法考后职业空间大' },
